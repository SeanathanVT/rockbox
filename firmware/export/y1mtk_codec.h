...
/* 5 dB step (4th field): one wheel tick moves 5 dB, so the -73..+6 dB range
 * is ~16 steps end to end -- the coarse, fast stepping the stock player uses
 * rather than ~80 1 dB ticks.  Also the Settings > Sound > Volume increment. */
